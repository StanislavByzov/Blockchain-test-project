...
window.onload = function () {
    ...
    window.addEventListener('message', function (event) {
        ...
        if (~event.origin.indexOf('http://127.0.0.1')) {
            ...
            if (message.message == 'Login OK') {
                console.log(message);
                document.getElementById('loginButton').style.display = 'none';
                document.getElementById('startButton').style.display = 'block';
            }
            if (message.message == 'Resize H') {
                console.log(message);
                document.body.style.height = message.value;
            }
            if (message.message == 'Resize W') {
                console.log(message);
                document.body.style.width = message.value;
            }
        } else {
    ...
    var btn = document.getElementById('startButton'),
        btnL = document.getElementById('loginButton'),
